...
This paper applies two analytical frameworks --- \emph{operator-algebraic
modelling} and \emph{kinetic-theory / BBGKY expansion} --- that originated
in mathematical physics and were adapted here to the analysis of a concurrent
scheduler.  We sketch the scope of each and the conditions under which the
transfer to distributed systems is lossless.
...
Model checkers (e.g.\ TLA+, Loom) verify correctness by state-space
...
\url{https://github.com/tokio-rs/tokio}, 2024.
